...
<!-- 0. include부분 -->
			<nav>
				<ul>
					...
					<li class="active"><a href="<c:url value='/confirm/complete.do'/>"><i class="fa fa-file-text"></i>&nbsp;<span>결재 완료함</span></a></li>
		...
		<article id="headsection">
			...
			<h1><i class="fa fa-book" aria-hidden="true"></i>&nbsp;전자 결재 - 결재 완료함&nbsp;<a href="#"><i class="fa fa-bookmark nobook" aria-hidden="true"></i></a></h1>
			<!-- 2. 페이지 이름 지정 끝 -->
		</article>	
