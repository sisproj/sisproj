...
<link href="<c:url value='/resources/css/pagecss/confirm_await.css'/>" rel="stylesheet" type="text/css">
<!-- 0. include부분 -->
			<nav>
				<ul>
					...
					<li class="active"><a href="<c:url value='/confirm/postbox.do'/>"><i class="fa fa-archive"></i>&nbsp;<span>참조 수신함</span></a></li>
		...
		<article id="headsection">
			...
			<h1><i class="fa fa-archive" aria-hidden="true"></i>&nbsp;참조 수신함&nbsp;<a href="#"><i class="fa fa-bookmark nobook" aria-hidden="true"></i></a></h1>
			<!-- 2. 페이지 이름 지정 끝 -->
		</article>	
		<article id="bodysection">
			<form name="frmPaging" method="post" action="<c:url value='/confirm/postbox.do'/>">
				<!-- 페이징 처리용 -->
				...
				<table id="awaittb">
					...
					<tbody>
						<c:if test="${empty docuList }">
							<tr><td colspan="5" rowspan="2" style="text-align:center; font-size: 1em;">문서가 없습니다</td></tr>
						</c:if>
						<c:if test="${!empty docuList }">
