     ...
     <!-- 0. include부분 -->
        ...
        <nav>
            <ul>
                ...
                <li><a href="#"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;<span>정보 수정</span></a></li>
            </ul>
            <!-- 1.왼쪽 사이드 메뉴 지정 끝-->
      	...
      	<form id="frmEmp" name="frmEMP" action="">
      	  <fieldset>
  		    <div id="diId">
       		...
       		<div id="diPwd">
      	 		<label for="name">비밀번호</label><input type="password" id="pwd" name="pwd">   
       		</div>
       		<div id="diName">
	        ...
	        <div id="diZipcode">
				...
				<label for="address" id="address" style="margin-top: 17px;">주소</label>
