...
<script type="text/javascript">
	$(function(){
		$('#myAddressUp').hide();
		$('#myAddressDown').show();
		$('.active span, .myAddress').click(function(){
        ...
        <nav>
            <ul>
                ...
                <li class="active"><a href="#"><i class="fa fa-address-book-o"></i>&nbsp;<span>내 주소록</span>
                ...
                <li><a href="#"><i class="fa fa-user-plus"></i>&nbsp;<span>연락처 추가</span></a></li>
                <li><a href="#"><i class="fa fa-users"></i>&nbsp;<span>그룹 추가</span></a></li>
                <li><a href="#"><i class="fa fa-trash"></i>&nbsp;<span>휴지통</span></a></li>
    ...
    <article id="bodysection">
        ...
        <div id="divBodysection">
	        <div class="divAddrHeader">
		        ...
		        <a href="#"><div><i class="fa fa-sign-out"></i><span> 주소록 내보내기</span></div></a>
