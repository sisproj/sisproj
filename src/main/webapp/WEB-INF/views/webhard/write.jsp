...
<%@include file="../inc/top.jsp" %>
    ...
    <article id="bodysection">
        <!-- 3. 내용 -->
        <div id="requireWrite">
	        <form name="writeFrm" id="writeFrm" method="post" action="<c:url value='/webhard/write.do'/>">
				<div id="divTitle">
					<label for="title">제목</label><input id="title" name="webTitle">
				</div>
				<div id="divContent">
					<textarea id="ir1" name="webContent"></textarea>
				</div>
				<div id="btns">
