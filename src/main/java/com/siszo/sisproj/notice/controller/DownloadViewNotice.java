...
@Component
public class DownloadViewNotice extends AbstractView{
	private static final Logger logger
	=LoggerFactory.getLogger(DownloadViewNotice.class);
	
	public DownloadViewNotice() {
