package com.siszo.sisproj.commue.common;
...
public class ComSearchVO {
   ...
   /**
     ...
     * @param bean 검색조건
     */
    public void setSearchVO(ComSearchVO bean){
    	...
    	this.searchDate = bean.searchDate;
    }
	...
	public String toString() {
		return "ComSearchVO [searchCondition=" + searchCondition + ", searchKeyword=" + searchKeyword + ", searchUseYn="
				+ searchUseYn + ", currentPage=" + currentPage + ", searchDate=" + searchDate + ", blockSize="
